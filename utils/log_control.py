...
INFO = LogHandler(ensure_path_sep(f"\\log\\info-{now_time_day}.log"), level='info')
ERROR = LogHandler(ensure_path_sep(f"\\log\\error-{now_time_day}.log"), level='error')
WARNING = LogHandler(ensure_path_sep(f'\\log\\warning-{now_time_day}.log'))
